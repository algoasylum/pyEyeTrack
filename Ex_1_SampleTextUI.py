...
class MainWindow(QMainWindow):
    """
    This class is used to display text line by line provided to it in the form of a txt file.
    The user needs to press Ctrl to display a line. When the user has finished reading, the shift key should be pressed.
    Meanwhile, the library will track the user's eyes as the user reads the line.    
    ...
    def __init__(self, path, *args, **kwargs):
        ...
        with open('Timestamps_per_line.csv','w') as file:     #Opens and writes the timestamps to the CSV
