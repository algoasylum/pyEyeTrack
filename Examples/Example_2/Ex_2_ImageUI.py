...
class Example(QWidget):
    ...
    Args:
        QWidget : The QWidget class provides the basic capability to 
        render to the screen, and to handle user input events.
    """
    ...
    def __init__(self, path):
        ...
        # Calls the stopByBlinks function to stop the UI after 
        # 2 blinks are detected
        self.stopByBlinks()
    ...
    def stopByBlinks(self):
        """
        This function monitors the blink count. 
        It primarily detects if the user has blinked twice.
...
def main():
    ...
    The function displays the image on the PyQt window and closes it 
    when two blinks are detected.
    """
    path = r'Examples\Example_2\wallpaper.jpg'
